...
public class MetadataSerDeser {
    ...
    public static <K> K deserialize(InputStream is, TypeReference typeRef) {
        ...
        try {
            ...
            LOG.error("error in deserializing metadata of type {} from input stream", new TypeReference<K>() {
            }.getType().getTypeName(), ex);
        }
        return null;
    }
    ...
    public static <K> K deserialize(InputStream is, Class<K> cls) {
        ...
        try {
            ...
            LOG.error("Got error to deserialize metadata of type {} from input stream", new TypeReference<K>() {
            }.getType().getTypeName(), ex);
        }
        return null;
    }
    ...
    public static <K> K deserialize(String json, TypeReference typeRef) {
        ...
        try {
            ...
            LOG.error("error in deserializing metadata of type {} from {}", new TypeReference<K>() {
            }.getType().getTypeName(), json, ex);
        }
        return null;
    }
