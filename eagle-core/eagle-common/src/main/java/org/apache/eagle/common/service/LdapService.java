...
public class LdapService {
    ...
    private static final String SECURITY_PRINCIPAL_CONFIG_NAME = "eagle.ldap.security-principal";
    private static final String SECURITY_CREDENTIALS_CONFIG_NAME = "eagle.ldap.security-credentials";
    private static final String LDAP_SERVER_CONFIG_NAME = "eagle.ldap.server";
    private static final String LDAP_CERTS_CONFIG_NAME = "eagle.ldap.certs";
    private static final String DEFAULT_LDAP_CERTS_FILE_NAME = "jssecacerts";
    ...
    protected DirContext getDirContext(int id) {
        ...
        try {
            ...
            ctx = null;
            LOG.error("LDAP authentication failed with exception: " + ex.getMessage(), ex);
        }
        return ctx;
    }
    ...
    public boolean authenticate(int id, String userName, String password) {
        ...
        if (ctx != null) {
            try {
                ...
                if (userDN != null) {
                    Hashtable<String, String> uenv = new Hashtable<>();
