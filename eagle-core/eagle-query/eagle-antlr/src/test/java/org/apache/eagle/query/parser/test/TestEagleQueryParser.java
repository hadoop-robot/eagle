...
public class TestEagleQueryParser {
    ...
    public void testANDORCombination() {
        ...
        LOG.info(or.toString());
        Assert.assertEquals("(@cluster=\"abc\" AND @datacenter=\"dc1\") OR (@host=\"dc123.xyz.com\" AND @datacenter=\"dc1\")",
            or.toString());
        ...
        LOG.info(or.toString());
        Assert.assertEquals("(@cluster=\"abc\" AND @datacenter=\"dc1\") "
            + "OR (@cluster=\"abc\" AND @cluster=\"bcd\") OR (@host=\"dc123.xyz.com\" AND @datacenter=\"dc1\") "
            + "OR (@host=\"dc123.xyz.com\" AND @cluster=\"bcd\")", or.toString());
        ...
        LOG.info(or.toString());
        Assert.assertEquals("(@cluster=\"abc\" AND @datacenter=\"dc1\" AND @cluster=\"bcd\") "
            + "OR (@host=\"dc123.xyz.com\" AND @datacenter=\"dc1\" AND @cluster=\"bcd\")", or.toString());
    }
