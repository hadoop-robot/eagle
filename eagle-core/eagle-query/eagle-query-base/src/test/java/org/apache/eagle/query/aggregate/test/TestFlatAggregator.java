...
public class TestFlatAggregator {
    ...
    public void testSingleGroupbyFieldSingleFunctionForSummary() {
        ...
        try {
            ...
            Assert.assertEquals(result.get(Arrays.asList("cluster2")).get(0),
                (double) (entities[3].getNumHosts() + entities[4].getNumHosts()), 0.001);
        } catch (Exception ex) {
            LOG.error("Can not aggregate", ex);
            Assert.fail("Can not aggregate");
        }
        ...
        try {
            ...
            Assert.assertEquals(result.get(Arrays.asList("cluster2")).get(0),
                (double) (entities[3].getNumClusters() + entities[4].getNumClusters()), 0.001);
        } catch (Exception ex) {
            LOG.error("Can not aggregate", ex);
            Assert.fail("Can not aggregate");
        }
        ...
        try {
            ...
            Assert.assertEquals(result.get(Arrays.asList("dc2")).get(0),
                (double) (entities[4].getNumClusters()), 0.001);
        } catch (Exception ex) {
            LOG.error("Can not aggregate", ex);
            Assert.fail("Can not aggregate");
        }
    ...
    public void testMultipleFieldsSingleFunctionForSummary() {
        ...
        try {
            ...
            Assert.assertEquals(result.get(Arrays.asList("cluster2", "unassigned")).get(0),
                (double) (entities[5].getNumHosts()), 0.001);
        } catch (Exception ex) {
            LOG.error("Can not aggregate", ex);
            Assert.fail("Can not aggregate");
        }
        ...
        try {
            ...
            Assert.assertEquals(result.get(Arrays.asList("cluster1", "dc1", "rack128")).get(0),
                (double) (entities[2].getNumHosts()), 0.001);
            Assert.assertEquals(result.get(Arrays.asList("cluster2", "dc1", "rack125")).get(0),
                (double) (entities[3].getNumHosts()), 0.001);
            Assert.assertEquals(result.get(Arrays.asList("cluster2", "dc1", "rack126")).get(0),
                (double) (entities[4].getNumHosts()), 0.001);
            Assert.assertEquals(result.get(Arrays.asList("cluster2", "unassigned", "rack126")).get(0),
                (double) (entities[5].getNumHosts()), 0.001);
        } catch (Exception ex) {
            LOG.error("Can not aggregate", ex);
            Assert.fail("Can not aggregate");
    ...
    public void testMultipleFieldsSingleFunctionForCount() {
        ...
        FlatAggregator agg = new FlatAggregator(Arrays.asList("cluster", "datacenter"),
    ...
    public void testSingleGroupbyFieldMultipleFunctions() {
        ...
        try {
            ...
            Assert.assertEquals(result.get(Arrays.asList("cluster1")).get(0),
                (double) (entities[0].getNumHosts() + entities[1].getNumHosts() + entities[2].getNumHosts()), 0.001);
            Assert.assertEquals(result.get(Arrays.asList("cluster1")).get(1),
                (double) (3), 0.001);
            Assert.assertEquals(result.get(Arrays.asList("cluster2")).get(0),
                (double) (entities[3].getNumHosts() + entities[4].getNumHosts()), 0.001);
            Assert.assertEquals(result.get(Arrays.asList("cluster2")).get(1),
                (double) (2), 0.001);
        } catch (Exception ex) {
            LOG.error("Can not aggregate", ex);
            Assert.fail("Can not aggregate");
        ...
        try {
            ...
            Assert.assertEquals(result.get(Arrays.asList("dc1")).get(1),
                (double) (entities[0].getNumHosts() + entities[1].getNumHosts() + entities[2].getNumHosts() + entities[3].getNumHosts()) + entities[4].getNumHosts(), 0.001);
        } catch (Exception ex) {
            LOG.error("Can not aggregate", ex);
            Assert.fail("Can not aggregate");
        }
        ...
        try {
            ...
            Assert.assertEquals(result.get(Arrays.asList("dc1")).get(2),
                (double) (entities[0].getNumClusters() + entities[1].getNumClusters() + entities[2].getNumClusters() + entities[3].getNumClusters()) + entities[4].getNumClusters(), 0.001);
        } catch (Exception ex) {
            LOG.error("Can not aggregate", ex);
            Assert.fail("Can not aggregate");
        }
