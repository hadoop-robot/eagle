...
public class RunningJobCrawlerImpl implements RunningJobCrawler {
    ...
    private RunningJobCrawlConfig.RunningJobEndpointConfig endpointConfig;
    private RunningJobCrawlConfig.ControlConfig controlConfig;
    ...
    private static final long DELAY_TO_UPDATE_COMPLETION_JOB_INFO = 5 * DateUtils.MILLIS_PER_MINUTE;
